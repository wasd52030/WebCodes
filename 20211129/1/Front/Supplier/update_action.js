...
export function editpage(id) {
    axios.post('http://localhost/20211129/1/Back/public/index.php?action=getSuppliers', Qs.stringify({ id: id }))
        .then(res => {
            console.log(res)
...
function UpdateAction() {
    ...
    $("#Update").click(function (e) {
        ...
        axios.post('http://localhost/20211129/1/Back/public/index.php?action=updateSupplier', Qs.stringify(data))
            .then(res => {
                let d = res['data'];
